...
<body>
    ...
    */
	...
	<!-- переключение кнопок + и - в описании товара -->
	<script>
		// сделаем кнопки с классом: disabled (для товаров которых нет в наличии) кнопки (в корзину и пожелания) не кликабильными
